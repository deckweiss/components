	...
	{#each versions as version (version.version)}
		...
		<article
			class="bg-card max-w-2xl rounded-lg border p-6 shadow-sm {isLatest
				...
				: ''}"
		>
			<!-- Header: title + button (button stays close to heading on all breakpoints) -->
			...
			<div class="space-y-4">
				{#if version.detailedChanges.newFeatures.length > 0}
					<section>
						...
						<ul class="text-muted-foreground list-outside list-disc space-y-1 pl-4.5 text-sm">
